...
import { incrementCustomProperty, getCustomProperty } from "./htmlInterface.js";

const carElement = document.querySelector("[data-car]");

const CAR_MAX_DRIVE_SPEED = 0.5;
const CAR_ACCELERATION = 0.005;
const CAR_DEACCELERATION_BREAK = 0.009;
const CAR_DEACCELARATION_AUTOMATIC = 0.002;
const CAR_MAX_TURN_SPEED = 0.05;
const CAR_DELTA_TURN_SPEED = 0.005;
