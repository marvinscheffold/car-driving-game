...
export class Rectangle {
    ...
    constructor(center, width = 1, height = 1, rotation = 0) {
        ...
        this.A = this.originalA.rotate(this.center, this.rotation);
        this.B = this.originalB.rotate(this.center, this.rotation);
        this.C = this.originalC.rotate(this.center, this.rotation);
        this.D = this.originalD.rotate(this.center, this.rotation);
